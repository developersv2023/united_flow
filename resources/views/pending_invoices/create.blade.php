...
@section('title', 'United Flow - Registrar Factura')
@section('page-title', 'Registrar Factura')
@section('page-breadcrumb', 'Gestión / Facturas / Nueva')

@section('content')
    <div class="p-10 space-y-10">
        <div class="bg-white rounded-[2.5rem] p-10 custom-shadow border border-slate-100 max-w-4xl mx-auto">

            <div class="mb-10 text-center">
                <div class="size-16 rounded-2xl bg-primary/10 flex items-center justify-center text-primary mx-auto mb-4">
                    <span class="material-symbols-outlined text-4xl font-variation-fill">receipt_long</span>
                </div>
                <h2 class="text-2xl font-black text-slate-900 leading-tight">Registrar Nueva Factura</h2>
                <p class="text-sm text-slate-400 font-medium mt-1">Completa los datos de la factura pendiente</p>
            </div>

            <form action="{{ route('pending_invoices.store') }}" method="POST" class="space-y-8">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="factura_num" value="{{ old('factura_num') }}" required
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" step="0.01" min="0" name="monto" value="{{ old('monto', 0) }}" required
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="mes_facturado" value="{{ old('mes_facturado') }}"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="dias_vencido" value="{{ old('dias_vencido', 0) }}" required min="0"
                                placeholder="Ej. 15"
                                class="w-full bg-slate-50 border-none rounded-2xl pl-12 pr-4 py-4 text-sm font-bold text-slate-600 focus:ring-2 focus:ring-primary focus:bg-white transition-all">
                        </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <select name="estado" required
                                ...
                                <option value="INCOBRABLE" {{ old('estado') == 'INCOBRABLE' ? 'selected' : '' }}>INCOBRABLE
                                </option>
                            </select>
                        </div>

...
@section('title', 'United Flow - Registrar Venta AWB')
@section('page-title', 'Registrar Venta AWB')
@section('page-breadcrumb', 'Gestión / Ventas / Nueva')

@section('content')
    <div class="p-10 space-y-10">
        <div class="bg-white rounded-[2.5rem] p-10 custom-shadow border border-slate-100 max-w-6xl mx-auto">

            <div class="mb-10 text-center">
                <div class="size-16 rounded-2xl bg-primary/10 flex items-center justify-center text-primary mx-auto mb-4">
                    <span class="material-symbols-outlined text-4xl font-variation-fill">flight_takeoff</span>
                </div>
                <h2 class="text-2xl font-black text-slate-900 leading-tight">Registrar Nueva Venta (AWB)</h2>
                <p class="text-sm text-slate-400 font-medium mt-1">Completa los datos operativos y financieros del registro
                </p>
            </div>

            <form action="{{ route('sales.store') }}" method="POST" class="space-y-12">
                @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                        ...
                        <div class="md:col-span-1">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="awb" value="{{ old('awb') }}" required
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-5 gap-6">
                        ...
                        <div class="md:col-span-1">
                            ...
                            <div class="relative">
                                ...
                                <input type="number" step="0.01" min="0" name="peso" value="{{ old('peso', 0) }}" required
                                    placeholder="Kg"
                                    class="w-full bg-slate-50 border-none rounded-2xl pl-12 pr-4 py-4 text-sm font-bold text-slate-600 focus:ring-2 focus:ring-primary focus:bg-white transition-all">
                            </div>
                        ...
                        <div class="md:col-span-1">
                            ...
                            <div class="relative">
                                ...
                                <input type="number" step="0.0001" min="0" name="tarifa_publica"
                                    value="{{ old('tarifa_publica', 0) }}" required
                                    class="w-full bg-slate-50 border-none rounded-2xl pl-12 pr-4 py-4 text-sm font-bold text-slate-600 focus:ring-2 focus:ring-primary focus:bg-white transition-all">
                            </div>
                        ...
                        <div class="md:col-span-1">
                            ...
                            <div class="relative">
                                ...
                                <input type="number" step="0.0001" min="0" name="tarifa_neta"
                                    value="{{ old('tarifa_neta', 0) }}" required
                                    class="w-full bg-slate-50 border-none rounded-2xl pl-12 pr-4 py-4 text-sm font-bold text-slate-600 focus:ring-2 focus:ring-primary focus:bg-white transition-all">
                            </div>
                        ...
                        <div class="md:col-span-1">
                            ...
                            <div class="relative">
                                ...
                                <input type="number" step="0.01" min="0" name="flete_p" value="{{ old('flete_p', 0) }}"
                                    required
                                    class="w-full bg-slate-50 border-none rounded-2xl pl-12 pr-4 py-4 text-sm font-bold text-slate-600 focus:ring-2 focus:ring-primary focus:bg-white transition-all">
                            </div>
                        ...
                        <div class="md:col-span-1">
                            ...
                            <div class="relative">
                                ...
                                <input type="number" step="0.01" min="0" name="flete_n" value="{{ old('flete_n', 0) }}"
                                    required
                                    class="w-full bg-slate-50 border-none rounded-2xl pl-12 pr-4 py-4 text-sm font-bold text-slate-600 focus:ring-2 focus:ring-primary focus:bg-white transition-all">
                            </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-6 gap-6">
                        ...
                        <div class="md:col-span-1">
                            ...
                            <div class="relative">
                                <input type="number" step="0.01" min="0" name="gastos_gc" value="{{ old('gastos_gc', 0) }}"
                                    required
                        ...
                        <div class="md:col-span-1">
                            ...
                            <div class="relative">
                                <input type="number" step="0.01" min="0" name="gastos_oa" value="{{ old('gastos_oa', 0) }}"
                                    required
                                    class="w-full bg-slate-50 border-none rounded-2xl px-4 py-4 text-sm font-bold text-slate-600 focus:ring-2 focus:ring-primary focus:bg-white transition-all">
                            </div>
                        ...
                        <div class="md:col-span-1">
                            ...
                            <div class="relative">
                                <input type="number" step="0.01" name="incentivo" value="{{ old('incentivo', 0) }}"
                                    class="w-full bg-slate-50 border-none rounded-2xl px-4 py-4 text-sm font-bold text-slate-600 focus:ring-2 focus:ring-primary focus:bg-white transition-all">
                            </div>
                        </div>
                        ...
                        <div class="md:col-span-1">
                            ...
                            <div class="relative">
                                <input type="number" step="0.01" name="diferencial" value="{{ old('diferencial', 0) }}"
                                    class="w-full bg-slate-50 border-none rounded-2xl px-4 py-4 text-sm font-bold text-slate-600 focus:ring-2 focus:ring-primary focus:bg-white transition-all">
                            </div>
                        </div>
                        ...
                        <div class="md:col-span-1">
                            ...
                            <div class="relative">
                                <input type="number" step="0.01" name="sobreventa" value="{{ old('sobreventa', 0) }}"
                                    class="w-full bg-slate-50 border-none rounded-2xl px-4 py-4 text-sm font-bold text-slate-600 focus:ring-2 focus:ring-primary focus:bg-white transition-all">
                            </div>
                        </div>
                        ...
                        <div class="md:col-span-1">
                            <label
                                ...
                                Tarifa</label>
                            <div class="relative">
                                <input type="number" step="0.01" name="tarifa_ajuste" value="{{ old('tarifa_ajuste', 0) }}"
                                    class="w-full bg-slate-50 border-none rounded-2xl px-4 py-4 text-sm font-bold text-slate-600 focus:ring-2 focus:ring-primary focus:bg-white transition-all">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 bg-slate-50 p-6 rounded-3xl border border-slate-100">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" step="0.01" name="total_pp" value="{{ old('total_pp', 0) }}" required
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" step="0.01" name="total_cc" value="{{ old('total_cc', 0) }}" required

...
@section('title', 'United Flow - Editar Cliente')
@section('page-title', 'Edición de Cliente')
@section('page-breadcrumb', 'Catálogos / Clientes / Editar')
    ...
    <div class="p-10 space-y-10">
        <div class="bg-white rounded-[2.5rem] p-10 custom-shadow border border-slate-100 max-w-3xl mx-auto relative">
            ...
            <div class="mb-10 text-center">
                ...
                <h2 class="text-2xl font-black text-slate-900 leading-tight">Actualizar Cliente</h2>
                <p class="text-sm text-slate-400 font-medium mt-1">Sincroniza los cambios en el directorio</p>
            </div>
            ...
            <form action="{{ route('clients.update', $client) }}" method="POST" class="space-y-8">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="nit" value="{{ old('nit', $client->nit) }}" placeholder="Ej. 1234567-8"
                            class="w-full bg-slate-50 border-none rounded-2xl pl-12 pr-4 py-4 text-sm font-bold text-slate-600 focus:ring-2 focus:ring-primary focus:bg-white transition-all">
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 bg-slate-50 p-6 rounded-3xl border border-slate-100">
                    <label class="flex items-center justify-between cursor-pointer group">
                        ...
                        <div class="relative">
                            <input type="checkbox" name="activo" value="1" class="sr-only peer" {{ old('activo', $client->activo) ? 'checked' : '' }}>
                            <div
